...
Einkaufsliste = ["Spargel", "Erdbeeren", "Katzenfutter"]
sample_list = [1, 1.5, False, True, "Katze", [Einkaufsliste]]
...
sample_list.append("Katzenstreu")
...
print(sample_string)
sample_word = [sample_string, 1, 1.5, "Zuzu", "Iroh", "Kater"]
first_word = sample_word[0]
last_word = sample_word[-1]

first_word_type = type(first_word)
last_word_type = type(last_word)
...
first_slice = sample_word[0:2+1]
# Vom dritten bis zum letzten Element
second_slice = sample_word[2:6+1]
# Vom zweiten bis zum vorletzten Element
third_slice = sample_word[1:-1]
...
result_string = " ".join(sample_word)
